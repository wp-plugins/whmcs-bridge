    ...
    <?php if ($controlpanelOptions) {
        foreach ($controlpanelOptions as $value) {
            ...
            if ($value['type'] == "text" || $value['type'] == "password") {
                ...
                <tr>
                    <td colspan="2" style="border-bottom:1px dashed #ccc;"><em>
                            <small style="color:#212121"><?php echo $value['desc']; ?></small>
                        </em></td>
                </tr>
            ...
            <?php } elseif ($value['type'] == "heading") { ?>
                ...
                <tr>
                    <td colspan="2" style="text-align: center" style="border-bottom:1px dashed #ccc;">
                        <h4 style="color: darkblue; margin: 0 0; background: #f7f7f7; padding:4px;">
                            <em><?php echo $value['desc']; ?></em></h4>
                    </td>
                </tr>
